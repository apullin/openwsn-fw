...
void timer_appudptimer_fired() {
   ...
   if (appudptimer_vars.busySending==FALSE) {
      ...
      pkt->l3_destinationORsource.addr_128b[ 2]  = 0xf1;
      pkt->l3_destinationORsource.addr_128b[ 3]  = 0x40;
      pkt->l3_destinationORsource.addr_128b[ 4]  = 0x04;
      pkt->l3_destinationORsource.addr_128b[ 5]  = 0x00;
      pkt->l3_destinationORsource.addr_128b[ 6]  = 0x10;
      pkt->l3_destinationORsource.addr_128b[ 7]  = 0x36;
      pkt->l3_destinationORsource.addr_128b[ 8]  = 0x11;
      pkt->l3_destinationORsource.addr_128b[ 9]  = 0x59;
      pkt->l3_destinationORsource.addr_128b[10]  = 0x04;
      pkt->l3_destinationORsource.addr_128b[11]  = 0x90;
      pkt->l3_destinationORsource.addr_128b[12]  = 0x14;
      pkt->l3_destinationORsource.addr_128b[13]  = 0x27;
      pkt->l3_destinationORsource.addr_128b[14]  = 0x91;
      pkt->l3_destinationORsource.addr_128b[15]  = 0x78;
