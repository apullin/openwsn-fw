...
void gyro_get_config() {
   if (gyro_configured==TRUE) {
      i2c_read_registers(1,GYRO_I2C_ADDR, GYRO_REG_WHO_AM_I_ADDR   ,1,&reg_WHO_AM_I);
      i2c_read_registers(1,GYRO_I2C_ADDR, GYRO_REG_SMPLRT_DIV_ADDR ,1,&reg_SMPLRT_DIV);
      i2c_read_registers(1,GYRO_I2C_ADDR, GYRO_REG_DLPF_FS_ADDR    ,1,&reg_DLPF_FS);
      i2c_read_registers(1,GYRO_I2C_ADDR, GYRO_REG_INT_CFG_ADDR    ,1,&reg_INT_CFG);
      i2c_read_registers(1,GYRO_I2C_ADDR, GYRO_REG_INT_STATUS_ADDR ,1,&reg_INT_STATUS);
      i2c_read_registers(1,GYRO_I2C_ADDR, GYRO_REG_PWR_MGM_ADDR    ,1,&reg_PWR_MGM);
   }
}
