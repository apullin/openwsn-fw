...
void idmanager_init() {
   ...
   idmanager_vars.myPANID.panid[1]     = 0xAD;
   idmanager_vars.myPrefix.type        = ADDR_PREFIX;
   idmanager_vars.myPrefix.prefix[0]   = 0xde;
   idmanager_vars.myPrefix.prefix[1]   = 0xad;
   idmanager_vars.myPrefix.prefix[2]   = 0xbe;
   idmanager_vars.myPrefix.prefix[3]   = 0xef;
   idmanager_vars.myPrefix.prefix[4]   = 0xfa;
   idmanager_vars.myPrefix.prefix[5]   = 0xce;
   idmanager_vars.myPrefix.prefix[6]   = 0xca;
   idmanager_vars.myPrefix.prefix[7]   = 0xfe; 
