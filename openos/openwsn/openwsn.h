...
#define DEBUG_PIN_FRAME_OUT P1DIR |= DEBUG_PIN_FRAME
...
#define DEBUG_PIN_FRAME_TOGGLE P1OUT ^= DEBUG_PIN_FRAME
#define DEBUG_PIN_FRAME_CLR P1OUT &= ~DEBUG_PIN_FRAME
#define DEBUG_PIN_FRAME_SET P1OUT |= DEBUG_PIN_FRAME //toggle, clr and set
